...
data.raw.technology["engine"].prerequisites = {"machine-tool_0", "parts_1", "plumbing-steel", "rubber-a"}
...
data.raw.technology["electric-engine"].effects = {{type = "unlock-recipe", recipe = "coil-1-b"}, {type = "unlock-recipe", recipe = "motor-1-b"}, 
	{type = "unlock-recipe", recipe = "transformer-1"}}
