...
for i, element in ipairs(data.raw.particle["iron-ore-particle"].pictures) do
	...
	data.raw.particle["iron-ore-particle"].pictures[i].hr_version.filename = "__xander_mod__/graphics/entity/resource/particle/iron-ore/hr-" .. (i) .. ".png"
end
...
for i, element in ipairs(data.raw.particle["stone-particle"].pictures) do
	...
	data.raw.particle["stone-particle"].pictures[i].hr_version.filename = "__xander_mod__/graphics/entity/resource/particle/stone/hr-" .. (i) .. ".png"
end