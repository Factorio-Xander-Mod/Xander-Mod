...
--Copper Pipe
{
	...
	minable = {hardness = 0.2, mining_time = 0.5, result = "pipe-copper"},
	max_health = 50,
	...
	pictures = xm_pipe_pictures("copper"),
	working_sound =
	{
...
--Steel Pipe
{
	...
	flags = {"placeable-neutral", "player-creation"},
	minable = {hardness = 0.2, mining_time = 0.5, result = "pipe-steel"},
	max_health = 100,
	corpse = "small-remnants",
	resistances =
	{
	...
	vehicle_impact_sound = {filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65},
	pictures = xm_pipe_pictures("steel"),
	working_sound =
	{
		sound = {filename = "__base__/sound/pipe.ogg", volume = 0.85},
		match_volume_to_activity = true,
...
--Monel Pipe
{
	...
	flags = {"placeable-neutral", "player-creation"},
	minable = {hardness = 0.2, mining_time = 0.5, result = "pipe-monel"},
	max_health = 100,
	corpse = "small-remnants",
	resistances =
	{
	...
	vehicle_impact_sound = {filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65},
	pictures = xm_pipe_pictures("monel"),
	working_sound =
	{
		sound = {filename = "__base__/sound/pipe.ogg", volume = 0.85},
		match_volume_to_activity = true,
...
--Stainless Steel Pipe
{
	...
	flags = {"placeable-neutral", "player-creation"},
	minable = {hardness = 0.2, mining_time = 0.5, result = "pipe-stainless"},
	max_health = 200,
	corpse = "small-remnants",
	resistances =
	{
	...
	vehicle_impact_sound = {filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65},
	pictures = xm_pipe_pictures("stainless"),
	working_sound =
	{
		sound = {filename = "__base__/sound/pipe.ogg", volume = 0.85},
		match_volume_to_activity = true,
...
--Plastic Pipe
{
	...
	flags = {"placeable-neutral", "player-creation"},
	minable = {hardness = 0.2, mining_time = 0.5, result = "pipe-plastic"},
	max_health = 200,
	corpse = "small-remnants",
	resistances =
	{
	...
	vehicle_impact_sound = {filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65},
	pictures = xm_pipe_pictures("plastic"),
	working_sound =
	{
		sound = {filename = "__base__/sound/pipe.ogg", volume = 0.85},
		match_volume_to_activity = true,
...
--Superalloy Pipe
{
	...
	flags = {"placeable-neutral", "player-creation"},
	minable = {hardness = 0.2, mining_time = 0.5, result = "pipe-superalloy"},
	max_health = 200,
	corpse = "small-remnants",
	resistances =
	{
	...
	vehicle_impact_sound = {filename = "__base__/sound/car-metal-impact.ogg", volume = 0.65},
	pictures = xm_pipe_pictures("superalloy"),
	working_sound =
	{
		sound = {filename = "__base__/sound/pipe.ogg", volume = 0.85},
		match_volume_to_activity = true,
...
--Copper Pipe To Ground
{
	...
	flags = {"placeable-neutral", "player-creation"},
	minable = {hardness = 0.2, mining_time = 0.5, result = "pipe-to-ground-copper"},
	max_health = 50,
	corpse = "small-remnants",
	resistances =
	{
	...
	pictures =
	{
		up =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/copper/pipe-to-ground-up.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/copper/hr-pipe-to-ground-up.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		down =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/copper/pipe-to-ground-down.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/copper/hr-pipe-to-ground-down.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		left =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/copper/pipe-to-ground-left.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/copper/hr-pipe-to-ground-left.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		right =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/copper/pipe-to-ground-right.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/copper/hr-pipe-to-ground-right.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
...
--Steel Pipe To Ground
{
	...
	flags = {"placeable-neutral", "player-creation"},
	minable = {hardness = 0.2, mining_time = 0.5, result = "pipe-to-ground-steel"},
	max_health = 100,
	corpse = "small-remnants",
	resistances =
	{
	...
	fluid_box =
	{
		...
		{
			{position = {0, -1}},
			{position = {0, 1}, max_underground_distance = 19}
		}
	},
	underground_sprite =
	{
	...
	pictures =
	{
		up =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/steel/pipe-to-ground-up.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/steel/hr-pipe-to-ground-up.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		down =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/steel/pipe-to-ground-down.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/steel/hr-pipe-to-ground-down.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		left =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/steel/pipe-to-ground-left.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/steel/hr-pipe-to-ground-left.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		right =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/steel/pipe-to-ground-right.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/steel/hr-pipe-to-ground-right.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
...
--Monel Pipe To Ground
{
	...
	flags = {"placeable-neutral", "player-creation"},
	minable = {hardness = 0.2, mining_time = 0.5, result = "pipe-to-ground-monel"},
	max_health = 100,
	corpse = "small-remnants",
	resistances =
	{
	...
	pictures =
	{
		up =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/monel/pipe-to-ground-up.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/monel/hr-pipe-to-ground-up.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		down =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/monel/pipe-to-ground-down.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/monel/hr-pipe-to-ground-down.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		left =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/monel/pipe-to-ground-left.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/monel/hr-pipe-to-ground-left.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		right =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/monel/pipe-to-ground-right.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/monel/hr-pipe-to-ground-right.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
...
--Stainless Steel Pipe To Ground
{
	...
	flags = {"placeable-neutral", "player-creation"},
	minable = {hardness = 0.2, mining_time = 0.5, result = "pipe-to-ground-stainless"},
	max_health = 200,
	corpse = "small-remnants",
	resistances =
	{
	...
	fluid_box =
	{
		...
		{
			{position = {0, -1}},
			{position = {0, 1}, max_underground_distance = 29}
		}
	},
	underground_sprite =
	{
	...
	pictures =
	{
		up =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/stainless/pipe-to-ground-up.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/stainless/hr-pipe-to-ground-up.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		down =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/stainless/pipe-to-ground-down.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/stainless/hr-pipe-to-ground-down.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		left =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/stainless/pipe-to-ground-left.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/stainless/hr-pipe-to-ground-left.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		right =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/stainless/pipe-to-ground-right.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/stainless/hr-pipe-to-ground-right.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
...
--Plastic Pipe	To Ground
{
	...
	flags = {"placeable-neutral", "player-creation"},
	minable = {hardness = 0.2, mining_time = 0.5, result = "pipe-to-ground-plastic"},
	max_health = 200,
	corpse = "small-remnants",
	resistances =
	{
	...
	pictures =
	{
		up =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/plastic/pipe-to-ground-up.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/plastic/hr-pipe-to-ground-up.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		down =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/plastic/pipe-to-ground-down.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/plastic/hr-pipe-to-ground-down.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		left =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/plastic/pipe-to-ground-left.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/plastic/hr-pipe-to-ground-left.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		right =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/plastic/pipe-to-ground-right.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/plastic/hr-pipe-to-ground-right.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
...
--Superalloy Pipe To Ground
{
	...
	flags = {"placeable-neutral", "player-creation"},
	minable = {hardness = 0.2, mining_time = 0.5, result = "pipe-to-ground-superalloy"},
	max_health = 200,
	corpse = "small-remnants",
	resistances =
	{
	...
	pictures =
	{
		up =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/superalloy/pipe-to-ground-up.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/superalloy/hr-pipe-to-ground-up.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		down =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/superalloy/pipe-to-ground-down.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/superalloy/hr-pipe-to-ground-down.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		left =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/superalloy/pipe-to-ground-left.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/superalloy/hr-pipe-to-ground-left.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
		...
		right =
		{
			filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/superalloy/pipe-to-ground-right.png",
			priority = "high",
			width = 64,
			height = 64,
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pipe-to-ground/superalloy/hr-pipe-to-ground-right.png",
				priority = "extra-high",
				width = 128,
				height = 128,
				scale = 0.5
...
--Rotary Impeller Pump
{
	...
	animations =
	{
		north =
		{
			...
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pump-2/hr-north.png",
				width = 103,
				height = 164,
				scale = 0.5,
				line_length =8,
		...
		east =
		{
			...
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pump-2/hr-east.png",
				width = 130,
				height = 109,
				scale = 0.5,
				line_length =8,
		...
		south =
		{
			...
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pump-2/hr-south.png",
				width = 114,
				height = 160,
				scale = 0.5,
				line_length =8,
		...
		west =
		{
			...
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pump-2/hr-west.png",
				width = 131,
				height = 111,
				scale = 0.5,
				line_length =8,
...
--Turbomolecular Pump
{
	...
	animations =
	{
		north =
		{
			...
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pump-3/hr-north.png",
				width = 103,
				height = 164,
				scale = 0.5,
				line_length =8,
		...
		east =
		{
			...
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pump-3/hr-east.png",
				width = 130,
				height = 109,
				scale = 0.5,
				line_length =8,
		...
		south =
		{
			...
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pump-3/hr-south.png",
				width = 114,
				height = 160,
				scale = 0.5,
				line_length =8,
		...
		west =
		{
			...
			hr_version =
			{
				filename = "__xander-mod__/graphics/entity/logistic/pump-3/hr-west.png",
				width = 131,
				height = 111,
				scale = 0.5,
				line_length =8,
