...
xm_concentrate_recipes = {
	...
	{"hematite", "__xander-mod__/graphics/recipe/raw/hematite-washing.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 20, false, {{"milled-iron-ore", 10}, {type = "fluid", name = "water", amount = 50}}, {{"hematite", 10}, {"gravel", 2}, {type = "fluid", name = "gray-water", amount = 50}}, "concentrate"},
	{"pyrolusite", "__xander-mod__/graphics/recipe/raw/hematite-washing.png", "sluice", {primary = {r = 0.48, g = 0.34, b = 0.24}, secondary = {r = 0.5, g = 0.5, b = 0.5}, tertiary = {r = 0.75, g = 0.75, b = 0.75}}, 20, false, {{"milled-iron-ore", 10}, {type = "fluid", name = "water", amount = 50}}, {{"pyrolusite", 10}, {"gravel", 2}, {type = "fluid", name = "gray-water", amount = 50}}, "concentrate"},
