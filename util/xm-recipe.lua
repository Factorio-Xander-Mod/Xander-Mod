...
function xm_recipe(recipe_name, icon_path, category, tint, crafting_time, enabled, ingredients, results, subgroup)
	--Create a list for output recipe parameters
	local out = {type = "recipe", name = recipe_name}
	...
	out.energy_required = crafting_time
