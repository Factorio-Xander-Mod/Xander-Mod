...
xm_material_subgroups = {{"terrain", false}, {"raw-resource", false}, {"milled-resource", true}, {"concentrate", true}, {"oxide", true}, {"sponge", true}, {"plate", true}, {"ingot", true}, {"billet", true}, {"nonmetal", true}, {"ceramic", true}, {"salt", true}, {"organic", true}, {"polymer", true}, {"energetic", true}, {"waste", true}, {"raw-material", false}, {"fluid-recipes", false}, {"carbohydrate", true}, {"other-organic", true}, {"compound", true}}
...
xm_intermediate_products_subgroups = {{"structure", true}, {"mechanical", true}, {"electric-1", true}, {"electric-2", true}, {"electric-3", true}, {"data", true}, {"board", true}, {"optic", true}, {"assembly", true}, {"intermediate-product", false}, {"science-pack", false}, {"fill-barrel", false}, {"empty-barrel", false}}
...
xm_logistics_subgroups = {{"storage", false}, {"belt", false}, {"inserter", false}, {"pipe", true}, {"pipe-to-ground", true}, {"plumbing", true}, {"energy-pipe-distribution", false}, {"transport", false}, {"logistic-network", false}, {"circuit-network", false}}
